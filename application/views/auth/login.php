...
<div class="h-100 w-100 d-flex" id="login-main">
	...
	<div class="login-box-body col-lg-3 col-md-4 col-sm-10 col-xs-12">
		<h3 class="text-center mt-0 mb-4">
			<b>O</b>nline <b>E</b>xam for Final Project<b>PBKK B</b>
		</h3>
		<p class="login-box-msg">Harap Login untuk memulai sesi Anda</p>
		...
		<div class="row">
			<div class="col-xs-8">
				<div class="checkbox icheck">
					<label>
						<?= form_checkbox('remember', '', FALSE, 'id="remember"'); ?> Ingatkan Saya
					</label>
				</div>
			</div>
			<!-- /.col -->
